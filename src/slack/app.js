...
if (parts[0] === 'agg') {
        ...
        blocks: [
          {
            ...
            elements: [
              ...
              {
                type: 'button',
                text: { type: 'plain_text', text: 'Orders View' },
                action_id: 'home_toggle',
                value: 'dashboard'
              },
              {
    ...
    (async () => {
      try {
        ...
        await client.chat.postEphemeral({
          ...
          text: 'Publishing aggregated backorders isbn view to your App Home...',
        });
  ...
  slackApp.command('/sr-help', async ({ ack, body, client }) => {
    ...
    // Build modal blocks
    const commands = [
      { cmd: '/sr-back', desc: 'Refresh detailed backorders orders view', example: '/sr-back' },
